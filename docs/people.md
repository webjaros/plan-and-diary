People must always be sorted alphabetically.
...
## Lunar G Nuarta (Luna)
* Indonesian from Java, lives in Bali.
* My ex-lover (2024). We did not talk for a year or so.
* Now she's my SMM assistant for the Release Ritual project (only TikTok for now).
...
## Vija Juhnevica
* She has a bookkeping company Pozit SIA. Main bookkeeper of WebLab.

## Vita
* She is a worker of Pozit, who does routines for my bookkeeping.
